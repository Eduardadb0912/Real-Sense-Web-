...
<head>
    ...
    <link rel="stylesheet" href="../rsw1/vizualizar_objetivo.css">
    <title>Visualizar Depósito</title>
</head>
<body>
<header>
    ...
    <center>
        ...
        <table border="4">
            ...
            <?php
                ...
                $dados_select = mysqli_query($conn, "SELECT VALOR_DEPOSITO, DATA_DEPOSITO, HORARIO_DEPOSITO FROM deposito_objetivo");
